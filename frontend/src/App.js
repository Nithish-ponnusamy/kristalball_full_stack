...
function App() {
  ...
  const getIconPath = (iconType) => {
    const icons = {
      ...
      shopping:
        "M3 3h2l.4 2M7 13h10l4-8H5.4m0 0L7 13m0 0l-2.293 2.293c-.63.63-.184 1.707.707 1.707H17M17 13v4a2 2 0 01-2 2H9a2 2 0 01-2-2v-4m8 0V9a2 2 0 00-2-2H9a2 2 0 00-2 2v4.01",
      truck:
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {/* Main Content */}
      <main className="max-w-7xl mx-auto py-6 px-4">{renderCurrentPage()}</main>
    </div>
  );
}
